...
const mobileMenuData = ["home", "about", "projects", "contact"];
...
export const MobileMenu = ({ menuOpen, setMenuOpen }) => {
  return (
    <div
      ...
      {mobileMenuData.map((text, index) => (
        <a key={index} href={`#${text}`} onClick={() => setMenuOpen(false)} className={`text-2xl capitalize font-semibold text-white my-4 transform transition-transform duration-300
